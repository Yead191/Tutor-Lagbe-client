...
const AddTutorials = () => {
  ...
  const handleAddTutorial = (e) => {
    ...
    const selectedLanguages = Array.from(e.target.languageProficiency)
    ...
    toast.promise(
      axios.post(
        "https://tutor-lagbe-server.vercel.app/tutorials",
        tutorialData
      ),
      {
        loading: "Adding Tutorials...",
        success: <b>Successfully Added tutorials!</b>,
            ...
            <div className="grid grid-cols-2 gap-4 p-2 bg-white rounded-lg">
              ...
              <div className="flex items-center">
                <input
                  ...
                  className="checkbox checkbox-primary"
                />
                <label htmlFor="japanese" className="ml-2">
                  Japanese
                </label>
              </div>
              <div className="flex items-center">
