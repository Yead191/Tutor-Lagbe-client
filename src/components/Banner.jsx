        ...
        <div className="flex-1 pt-12">
          ...
          >
            <h1 className="text-[#800080] text-3xl lg:text-4xl xl:text-5xl font-bold">
              Best <span className="text-[#3c65f5]">Tutoring Platform</span>{" "}
              <br />
              for Home & Online Tuitions
            </h1>
            <div className="flex items-center text-xl font-thin text-gray-600 mt-4 mb-8 gap-2">
              <FaMapMarkerAlt />
              <p className="w-[260px] md:w-full">
                {" "}
                Find the Right Tutor For Your Faster Language Learn
              </p>
            </div>
          </motion.div>
          <Link
            to="/find-tutors"
            className="btn text-white flex items-center gap-2 btn-wide btn-lg rounded-full group hover:scale-105 hover:shadow-xl transition-transform duration-300"
            style={{
