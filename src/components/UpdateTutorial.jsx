...
const UpdateTutorial = () => {
  ...
  const handleUpdate = async (e) => {
    ...
    await toast.promise(
      axios.put(
        `https://tutor-lagbe-server.vercel.app/tutor/${_id}`,
        updatedTutorial
      ),
      {
        loading: "Updating tutorial...",
        success: <b>Tutorial Updated Successfully!</b>,
    ...
    <div>
      <div className="h-[250px] rounded-bl-[60px] rounded-br-[60px] w-11/12 mx-auto bg-[#540654] relative">
        <motion.h1
          ...
          className="text-3xl lg:text-4xl font-bold text-center text-white pt-12"
        >
          Update Tutorial
        </motion.h1>
      </div>
        ...
        >
          ...
          <div className="col-span-1 md:col-span-2 flex mt-3">
            <button
              disabled={isDisable}
              type="submit"
              className={`w-8/12 mx-auto  text-white font-medium py-2 px-4 rounded-lg transition hover:scale-105 ${
                isDisable
                  ? "cursor-not-allowed  bg-red-700"
                  : " text-white bg-gradient-to-r from-[#540654] via-[#cc0d85] to-[#540654]"
              }`}
            >
              Update Tutorial
            </button>
